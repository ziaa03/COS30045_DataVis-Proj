...
export default function Radar({ pm25_radar, population_radar, death_by_pm_radar, max_pm25_radar, median_age_radar, max_population_radar, max_death_by_pm_radar, max_median_age_radar }) {
    ...
    // array of values
    let maxValues = [max_pm25_radar, max_population_radar, max_death_by_pm_radar, max_median_age_radar];
    let ori_data = [pm25_radar, population_radar, death_by_pm_radar, median_age_radar];
    ...
    // captions or labels
    let features = ["PM2.5 Exposure Level", "Population", "Death by PM2.5", "Median Age"];
